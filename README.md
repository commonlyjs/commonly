...
### Installation
As an example, we will install a set of Commonly's core packages.
```shell script
npm install @commonly/function @commonly/iterable @commonly/logic @commonly/math @commonly/number @commonly/reflect @commonly/string @commonly/transducer @commonly/type
```
