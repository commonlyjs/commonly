...
describe("function filter(predicate, iterable)", () => {
    context("iterable is an array", () => {
        ...
        context("iterable is not empty", () => {
            ...
            it("should return an array containing only even values", () => {
    ...
    context("iterable is an instance of Set", () => {
        ...
        context("iterable is not empty", () => {
            ...
            it("should return an instance of Set containing only odd values", () => {
    ...
    context("iterable is an instance of Map", () => {
        ...
        context("iterable is not empty", () => {
            ...
            it("should return an instance of Map containing only values of which sum of key and value is odd", () => {
                const expected: Map<number, number> = new Map([
                    [ 2, 1 ], [ 3, 2 ], [ 4, 3 ]
                ])
    ...
    context("iterable is a custom finite iterator-based collection", () => {
        ...
        context("iterable is not empty", () => {
            ...
            it("should return a custom collection containing only odd values", () => {
